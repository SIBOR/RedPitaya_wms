...
--               Stuff/wlMod_remote/redPitayaLock-in/lockInMeasure_quadInterleaved_working/lockInMeasure_quadInterleaved/lockInMeasure_quadInterleaved.gen/sources_1/bd/system/ip/system_ramp_generator_0_0/system_ramp_generator_0_0_sim_netlist.vhdl}
...
entity system_ramp_generator_0_0_ramp_generator is
  ...
  attribute ORIG_REF_NAME of system_ramp_generator_0_0_ramp_generator : entity is "ramp_generator";
...
\ramp_out_next1_carry__1_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\ramp_out_next1_carry__1_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\ramp_out_next1_carry__1_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
ramp_out_next1_carry_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFEFFFAAAA8A8A"
    )
        port map (
      I0 => count_reg(2),
      I1 => ramp_per(2),
...
ramp_out_next1_carry_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFEFAAAAAA88"
    )
        port map (
      I0 => count_reg(0),
      I1 => ramp_per(2),
...
ramp_out_next1_carry_i_7: unisim.vcomponents.LUT6
    generic map(
      INIT => X"1111111114111211"
    )
        port map (
      I0 => count_reg(2),
      I1 => count_reg(3),
...
ramp_out_next1_carry_i_8: unisim.vcomponents.LUT6
    generic map(
      INIT => X"1111111111111412"
    )
        port map (
      I0 => count_reg(0),
      I1 => count_reg(1),
